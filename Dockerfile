...
ENV LGTM_VERSION=0.2.0
ENV LGTM_BINARY_URL=https://github.com/brunojdo/lgtm-gitlab/releases/download/v$LGTM_VERSION/lgtm-alpine-linux-amd64-v$LGTM_VERSION.tar.gz
